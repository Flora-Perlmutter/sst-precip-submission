...
python3 /dartfs-hpc/rc/lab/C/CMIG/fperlmutter/git_repos/sst-precipitation-sensitivity/code/scripts/13_Linear_Regression_Randomization.py --pair-index $SLURM_ARRAY_TASK_ID
