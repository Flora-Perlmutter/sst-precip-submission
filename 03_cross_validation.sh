...
"$PYTHON" /dartfs-hpc/rc/lab/C/CMIG/fperlmutter/git_repos/sst-precip-submission/code/scripts/08_Ensemble_Cross_Validation.py --pair-index $SLURM_ARRAY_TASK_ID
