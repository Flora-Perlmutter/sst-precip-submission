...
python3 /dartfs-hpc/rc/lab/C/CMIG/fperlmutter/git_repos/sst-precipitation-sensitivity/code/scripts/11_Linear_Regression_Bootstrap_SE.py --pair-index $SLURM_ARRAY_TASK_ID
