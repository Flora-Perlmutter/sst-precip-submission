...
# coding: utf-8
"""
Figure 8: Average SST sensitivity and SST variability maps.
...
cbar2 = fig.colorbar(sm2, ax=ax2, ticks=cbar_ticks_2,
                     orientation='horizontal', extend='neither',
                     shrink=0.8, pad=0.05)
ax2.set_title("Average SST-Forced Contribution")
...
# Print summary
# ----------------------------------------------------------
print("Observed SST Sensitivity Summary")
print("-" * 50)
