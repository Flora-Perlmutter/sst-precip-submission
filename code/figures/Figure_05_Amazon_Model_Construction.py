...
# coding: utf-8
"""
Figure 5: Amazon basin model construction.
...
Output
------
  figures/paper_figures/Figure_5_amazon_model_construction.png
...
plt.savefig(FIGURES_DIR / f"Figure_5_amazon_model_construction.png", 
