...
Output
------
  figures/paper_figures/Figure_01_cross_validation.png  (repo-tracked)
...
MODEL_DISPLAY_NAMES = {
      ...
      "P ~ intercept + β1*SST + β2*log(SST)":                    "P ~ intercept + β₁*SST + β₂*log(SST)",
}
...
def plot_model_rankings(cv_ranks, figures_dir, metrics=None, verbose=True):
    ...
    outfile = FIGURES_DIR / 'Figure_01_cross_validation.png'
