...
python3 /dartfs-hpc/rc/lab/C/CMIG/fperlmutter/git_repos/sst-precipitation-sensitivity/code/scripts/12_RH_SST_Correlation.py --pair-index $SLURM_ARRAY_TASK_ID
