...
"$PYTHON" /dartfs-hpc/rc/lab/C/CMIG/fperlmutter/git_repos/sst-precip-submission/code/scripts/11_Linear_Regression_Bootstrap_SE.py --pair-index $SLURM_ARRAY_TASK_ID
