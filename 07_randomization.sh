...
python3 /dartfs-hpc/rc/lab/C/CMIG/fperlmutter/git_repos/sst-precip-submission/code/scripts/14_Linear_Regression_Randomization.py --pair-index $SLURM_ARRAY_TASK_ID
