#!/bin/bash
#SBATCH --job-name='run_amip_regression'
...
python3 /dartfs-hpc/rc/lab/C/CMIG/fperlmutter/git_repos/sst-precipitation-sensitivity/code/scripts/16_Linear_Regression_Bootstrap_SE_AMIP.py --pair-index $SLURM_ARRAY_TASK_ID
