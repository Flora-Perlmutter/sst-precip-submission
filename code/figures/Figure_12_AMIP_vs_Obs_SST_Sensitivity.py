...
# coding: utf-8
"""
Figure 12: AMIP vs observed SST sensitivity pattern correlation.

Author: Flora Perlmutter

Description
-----------
2-panel figure comparing AMIP and observed SST sensitivity spatial
patterns across GRDC basins:
  Panel A: Basin choropleth map colored by pattern correlation between
           AMIP and observed SST sensitivity (RdYlGn)
...
Output
------
  figures/paper_figures/Figure_12_amip_vs_obs_SST_sensitivity.png
"""
...
ax1.set_title('AMIP vs Observed SST Sensitivity')
ax1.set_global()
num_levels = 20
vmax=1
vmin=-1
...
ax_hist_2.set_xlabel("Average AMIP-Observed Correlation")
...
plt.savefig(FIGURES_DIR / f"Figure_12_amip_vs_obs_SST_sensitivity.png", 
