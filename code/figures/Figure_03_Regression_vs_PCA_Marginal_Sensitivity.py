...
# coding: utf-8
"""
Figure 3: Observed regression vs observed PCA marginal sensitivity pattern correlation.

Author: Flora Perlmutter

Description
-----------
2-panel figure comparing observed bootstrap and observed PCA marginal
...
Output
------
  figures/paper_figures/Figure_03_regression_vs_pca_marginal_sensitivity.png
"""
...
ax_map.set_global()
ax_map.set_title("Regression vs PCA Marginal Sensitivity")
...
ax_hist.set_xlabel("Regression vs PCA MS Correlation")
...
# Save
# ─────────────────────────────────────────────────────────────────────────────
out_fig = FIGURES_DIR / "Figure_03_regression_vs_pca_marginal_sensitivity.png"
